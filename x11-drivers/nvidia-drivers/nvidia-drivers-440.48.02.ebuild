...
NV_TOOLS_PV=$(ver_cut 1).$(ver_cut 2)

# FIX: for 435.24.*, not match 435.24 driver
if [[ "${PV}" == "440.48.02" ]]; then
        NV_TOOLS_PV="440.44"
fi

if [[ $(ver_cut 3) -gt 0 ]]; then
	AMD64_URI="${NV_DEV_URI}vulkan-beta-$(ver_cut 1)$(ver_cut 2)$(ver_cut 3)-linux -> NVIDIA-Linux-x86_64-${PV}.run"
else
